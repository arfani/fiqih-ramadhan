...
export const Pembahasan10: FC = () => {
    return (
        <>
            <h2 className='font-bold mb-2'>Pembahasan ulama yang berkaitan dengan sunnah-sunnah puasa dan adab-adanya sangatlah banyak</h2>
            <ol className='list-decimal list-inside mb-2'>
                <li className='[&>p]:indent-7'><span className='font-semibold'>Sunnah puasa yang paling utama yaitu : Makan Sahur</span>
                    <p>Nabi -sahallallahu ‘alaihi wa sallam- mengabarkan bahwa pada makan sahur terdapat keberkahan, maka selayaknya seorang muslim tidak melewati dan menyia-nyiakan keutamaan ini.</p>
                    <p>Dan sunnah yang paling utama adalah mengakhirkan makan sahur hingga beberapa saat sebelum terbitnya fajar, dan tidak boleh bagi seseorang untuk mengakhirkan makan sahur hingga telah terbit fajar kemudian dia mengatakan : Aku sedang mengakhirkan makan sahur. Maka hal ini tidaklah diperbolehkan.</p>
                </li>
                <li className='[&>p]:indent-7'><span className='font-semibold'>Menyegerakan berbuka puasa</span>
                    <p>Umat islam akan senantiasa di dalam kebaikan selama mereka menyegerakan berbuka puasa. Menyegerakan berbuka puasa tepat setelah terbenamnya matahari merupakan sunnah yang tidak sepantasnya di kesampingkan.</p>
                    <p>Dan yang paling baik bagi seorang untuk berbuka dengan kurma basah, bila dia kesulitan menemukan kurma basah, maka tidak mengapa dengan kurma kering, namun bila dia kesulitan menemukan kurma kering maka hendaknya dia berbuka dengan air, namun bila dia kesulitan menemukan air maka tidak mengapa dia berbuka dengan apa pun yang ada, namun bila tidak ada sesuatu pun dia temukan maka cukup dia berniat untuk berbuka puasa, alhamdulillah.</p>
                </li>
            </ol>

            <p className='font-semibold'>Dan terakhir atas seorang muslim wajib menjaga adab-adab puasa</p>
            <p>Puasa yang paling mudah di bulan ramadhan adalah meninggalkan makan dan minum!. Maimun bin Mihran rahimullah berkata :</p>
            <p>أهون الصيام ترك الشراب والطعام</p>
            <p>Artinya : “Sesungguhnya puasa yang paling ringan adalah meninggalkan makan dan minum.”</p>
            <p>Padanya terdapat perkara yang lebih agung yaitu puasanya pendengaranmu, puasanya penglihatanmu, puasanya lisanmu dari hal-hal yang Allah -subhanhu wa ta’ala- haramkan,</p>
            <p>Nabi -shallallahu ‘alai wa sallam- bersabda :</p>
            <p>مَنْ لَمْ يَدَعْ قَوْلَ الزُّورِ وَالْعَمَلَ بِهِ فَلَيْسَ لِلَّهِ حَاجَةٌ فِى أَنْ يَدَعَ طَعَامَهُ وَشَرَابَهُ</p>
            <p>Artinya : “Barangsiapa yang tidak meninggalkan perkataan dusta dan pengamalannya, maka Allah tidak butuh dari rasa lapar dan haus yang dia tahan.” (HR. Bukhari no. 1903).</p>
            <p>Berkata bohong adalah perkataan yang haram, beramal dengan penuh kebohongan merupakan kumpulan dari segala jenis keharaman, dan jahil merupakan bentuk kurang kehati-hatian, orang yang melampaui batas adab, seperti berkelahi dan bertengkar dengan orang lain serta yang lainnya.</p>
            <p>Abu Dzar -radhiallahu anhu- berkata :</p>
            <p>إذا صمت فتحفظ ما استطعت</p>
            ...
            <p>واحمل على جسد ترجو النجاة له    ***    فسوف تضرم أجساد بنيران</p>
